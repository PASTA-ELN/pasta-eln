...
class Ui_OntologyConfigurationBaseForm(object):
  def setupUi(self, OntologyConfigurationBaseForm):
    ...
    self.mainGridLayout.addWidget(self.attachmentsTableView, 12, 0, 1, 1)
  ...
  def retranslateUi(self, OntologyConfigurationBaseForm):
    ...
    self.addAtachmentPushButton.setText(_translate("OntologyConfigurationBaseForm", "+ Add Attachment"))
