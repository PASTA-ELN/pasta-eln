...
defaultDefinitions: list[list[Union[str,int]]] = [
  ...
  ["measurement","default",2, "comment", "What are the comments?",                       "",   "",  "",        ""],
  ...
  ["sample","default", 3,     "comment", "What are the comments?",                       "",   "",  "",        ""],
  ...
  ["instrument","default",2,  "comment", "What are the comments?",                       "",   "",  "",        ""],
  ["instrument","default",3,  "vendor", "Who is the vendor?",                            "",   "",  "",        ""],
  ["instrument/extension","default",0,  "name", "What is the name the instrument extension?",      "",   "",  "T",       ""],
  ["instrument/extension","default",1,  "tags", "What are the tags?",                    "",  "",  "",        ""],
  ["instrument/extension","default",2,  "comment", "What are the comments?",             "",   "",  "",        ""],
  ["instrument/extension","default",3,  "vendor", "Who is the vendor?",                  "",   "",  "",        ""],
]
