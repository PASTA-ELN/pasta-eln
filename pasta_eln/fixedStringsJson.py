...
configurationGUI: dict[str, Any] = {
  ...
  "dimensions": {
    ...
    "maxTableColumnWidth": [
      "Maximum column width in tables",
      400,
      [
        300,
        400,
    ...
    "imageSizeDetails": [
      "Image size in details view and form",
      600,
      [
        300,
        400,
    ...
    "maxProjectLeafHeight": [
      "Maximum height of item in project view",
      250,
      [
        200,
        250,
    ...
    "widthContent": [
      "Width of procedures in project view",
      600,
      [
        400,
        500,
    ...
    "docTypeOffset": [
      "Offset of document type in project view",
      500,
      [
        400,
        500,
    ...
    "frameSize": [
      "Frame width around items in project view",
      6,
      [
        4,
        6,
