...
| **F4** | Download data from the eLabFTW (development mode) |
| **F5** | Upload data to the eLabFTW |
...
THEME_COLOR_VALUES = {
  'dark': {'background': {'base': '#202124', 'input': '#3f4042', 'list': {}, 'panel': {'darken': 0.3}, 'popup': {'lighten': 0.3},
           ...
           'foreground': {'base': '#e4e7eb', 'defaultButton.disabledBackground': {'transparent': 0.2},
                          'disabled': {'transparent': 0.4}, 'disabledSelectionBackground': {'transparent': 0.2},
                          'icon': {'darken': 0.01}, 'icon.unfocused': {'transparent': 0.6},
                          'input.placeholder': {'transparent': 0.6},
                          'progressBar.disabledBackground': {'transparent': 0.2},
                          'slider.disabledBackground': {'transparent': 0.2},
                          'sliderTrack.inactiveBackground': {'transparent': 0.1}}, 'input.background': '#3f4042',
           'inputButton.hoverBackground': '#ffffff25', 'linkVisited': '#c58af8',
           'list.alternateBackground': '#ffffff0c', 'list.hoverBackground': '#ffffff13',
           'menubar.selectionBackground': '#ffffff25', 'popupItem.checkbox.background': '#ffffff19',
           'popupItem.selectionBackground': '#ffffff22',
           'primary': {'base': '#8ab4f7', 'button.activeBackground': {'darken': 0.14, 'transparent': 0.23},
           ...
           'scrollbar.background': '#ffffff10', 'scrollbarSlider.activeBackground': '#ffffff60',
           'scrollbarSlider.background': '#ffffff30', 'scrollbarSlider.disabledBackground': '#ffffff15',
           'scrollbarSlider.hoverBackground': '#ffffff45', 'statusBar.background': '#2a2b2e',
           'statusBarItem.activeBackground': '#ffffff34', 'statusBarItem.hoverBackground': '#ffffff22',
           'tab.activeBackground': '#ffffff00', 'tab.hoverBackground': '#ffffff18',
           'tabCloseButton.hoverBackground': '#ffffff25', 'table.alternateBackground': '#ffffff15',
           'tableSectionHeader.background': '#3f4042', 'textarea.inactiveSelectionBackground': '#ffffff20',
  ...
  'light': {'background': {'base': '#f8f9fa', 'input': '#f8f9fa', 'list': {}, 'panel': {'lighten': 0.5}, 'popup': {'lighten': 0.2},
            ...
            'foreground': {'base': '#4d5157', 'defaultButton.disabledBackground': {'transparent': 0.25},
                           'disabled': {'transparent': 0.4}, 'disabledSelectionBackground': {'transparent': 0.25},
                           'icon': {'darken': 0.05}, 'icon.unfocused': {'transparent': 0.6},
                           'input.placeholder': {'transparent': 0.6},
                           'progressBar.disabledBackground': {'transparent': 0.25},
                           'slider.disabledBackground': {'transparent': 0.25},
                           'sliderTrack.inactiveBackground': {'transparent': 0.2}}, 'input.background': '#f8f9fa',
            'inputButton.hoverBackground': '#00000018', 'linkVisited': '#660098',
            'list.alternateBackground': '#00000009', 'list.hoverBackground': '#00000013',
            'menubar.selectionBackground': '#00000020', 'popupItem.checkbox.background': '#00000019',
            'popupItem.selectionBackground': '#00000022',
            'primary': {'base': '#1a73e8', 'button.activeBackground': {'darken': 0.03, 'transparent': 0.24},
            ...
            'scrollbar.background': '#00000010', 'scrollbarSlider.activeBackground': '#00000060',
            'scrollbarSlider.background': '#00000040', 'scrollbarSlider.disabledBackground': '#00000015',
            'scrollbarSlider.hoverBackground': '#00000050', 'statusBar.background': '#dfe1e5',
            'statusBarItem.activeBackground': '#00000024', 'statusBarItem.hoverBackground': '#00000015',
            'tab.activeBackground': '#00000000', 'tab.hoverBackground': '#00000015',
            'tabCloseButton.hoverBackground': '#00000020', 'table.alternateBackground': '#00000012',
            'tableSectionHeader.background': '#dadce0', 'textarea.inactiveSelectionBackground': '#00000015',
            'toolbar.activeBackground': '#00000024', 'toolbar.background': '#ebebeb',
            'toolbar.hoverBackground': '#00000015', 'tree.inactiveIndentGuidesStroke': '#00000030',
            'tree.indentGuidesStroke': '#00000050', 'treeSectionHeader.background': '#dadce0'}
}
ACCENT_COLORS = {
  'dark': {
    'blue': '#8ab4f7',
