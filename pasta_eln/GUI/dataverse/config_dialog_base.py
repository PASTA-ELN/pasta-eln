...
class Ui_ConfigDialogBase(object):
  def setupUi(self, ConfigDialogBase):
    ...
    ConfigDialogBase.resize(963, 192)
    ...
    self.apitTokenVerifyPushButton = QtWidgets.QPushButton(parent=ConfigDialogBase)
    ...
    self.dataverseListPushButton = QtWidgets.QPushButton(parent=ConfigDialogBase)
  ...
  def retranslateUi(self, ConfigDialogBase):
    ...
    self.apitTokenVerifyPushButton.setToolTip(_translate("ConfigDialogBase", "Verify if the given dataverse server and api token are reachable."))
    self.apitTokenVerifyPushButton.setText(_translate("ConfigDialogBase", "Verify"))
    ...
    self.dataverseListPushButton.setToolTip(_translate("ConfigDialogBase", "Loads available dataverse"))
    self.dataverseListPushButton.setText(_translate("ConfigDialogBase", "Load"))
