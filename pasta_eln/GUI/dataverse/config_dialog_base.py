...
class Ui_ConfigDialogBase(object):
  ...
  def retranslateUi(self, ConfigDialogBase):
    ...
    self.dataverseLineEdit.setToolTip(_translate("ConfigDialogBase", "Displays the selected dataverse ID from the list"))
    self.dataverseLineEdit.setPlaceholderText(_translate("ConfigDialogBase", "Selected Dataverse ID"))
    self.dataverseLoadPushButton.setToolTip(_translate("ConfigDialogBase", "Loads available dataverse"))
