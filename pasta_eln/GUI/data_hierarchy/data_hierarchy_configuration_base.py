...
class Ui_DataHierarchyConfigurationBase(object):
  ...
  def retranslateUi(self, DataHierarchyConfigurationBase):
    ...
    self.typeComboBox.setToolTip(_translate("DataHierarchyConfigurationBase", "Select the type from the loaded data hierarchy types"))
    ...
    self.addTypePushButton.setToolTip(_translate("DataHierarchyConfigurationBase", "Add a new type (structural or normal type) to the data hierarchy data set."))
    ...
    self.saveDataHierarchyPushButton.setToolTip(_translate("DataHierarchyConfigurationBase", "Save loaded data hierarchy in local database"))
    self.saveDataHierarchyPushButton.setText(_translate("DataHierarchyConfigurationBase", "Save"))
