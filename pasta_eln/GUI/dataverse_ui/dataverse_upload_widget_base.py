...
class Ui_UploadWidgetFrame(object):
  def setupUi(self, UploadWidgetFrame):
    ...
    self.statusPushButton = QtWidgets.QPushButton(parent=UploadWidgetFrame)
    self.statusPushButton.setEnabled(True)
    self.statusPushButton.setText("")
    icon = QtGui.QIcon.fromTheme("finish")
    self.statusPushButton.setIcon(icon)
    self.statusPushButton.setObjectName("statusPushButton")
    self.uploadWidgetHorizontalLayout.addWidget(self.statusPushButton)
  ...
  def retranslateUi(self, UploadWidgetFrame):
    ...
    self.statusPushButton.setToolTip(_translate("UploadWidgetFrame", "Displays the status of the upload process (success/failed/in-progress)."))
