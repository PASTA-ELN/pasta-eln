...
class Ui_UploadWidgetFrame(object):
  def setupUi(self, UploadWidgetFrame):
    ...
    self.statusHorizontalLayout = QtWidgets.QHBoxLayout()
    self.statusHorizontalLayout.setObjectName("statusHorizontalLayout")
    ...
    self.statusIconLabel.setMinimumSize(QtCore.QSize(20, 20))
    self.statusIconLabel.setText("")
    self.statusIconLabel.setObjectName("statusIconLabel")
    self.statusHorizontalLayout.addWidget(self.statusIconLabel)
    ...
    self.statusHorizontalLayout.addWidget(self.statusLabel)
    self.uploadWidgetHorizontalLayout.addLayout(self.statusHorizontalLayout)
