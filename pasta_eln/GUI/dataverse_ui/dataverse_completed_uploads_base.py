...
class Ui_DataverseCompletedUploadsForm(object):
  def setupUi(self, DataverseCompletedUploadsForm):
    ...
    self.historyFilterLineEdit = QtWidgets.QLineEdit(parent=DataverseCompletedUploadsForm)
    ...
    self.filterPushButton = QtWidgets.QPushButton(parent=DataverseCompletedUploadsForm)
  ...
  def retranslateUi(self, DataverseCompletedUploadsForm):
    ...
    self.filterPushButton.setText(_translate("DataverseCompletedUploadsForm", "Filter"))
