...
class Ui_CreateTypeDialog(object):
  def setupUi(self, CreateTypeDialog):
    ...
    self.displayedTitleLineEdit = QtWidgets.QLineEdit(parent=CreateTypeDialog)
  ...
  def retranslateUi(self, CreateTypeDialog):
    ...
    self.titleLabel.setText(_translate("CreateTypeDialog", "Title in the hierarchy"))
    ...
    self.titleLineEdit.setPlaceholderText(_translate("CreateTypeDialog", "Enter the Data Type title for the hierarchy"))
    self.typeLabel.setText(_translate("CreateTypeDialog", "Displayed title"))
    self.displayedTitleLineEdit.setToolTip(_translate("CreateTypeDialog", "Enter displayed title for the new type, which can also be modified later in the main editor window"))
    self.displayedTitleLineEdit.setPlaceholderText(_translate("CreateTypeDialog", "Enter the displayed title of the Data Type"))
