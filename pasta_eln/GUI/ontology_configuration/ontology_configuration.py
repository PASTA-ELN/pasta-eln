...
class Ui_OntologyConfigurationBaseForm(object):
  def setupUi(self, OntologyConfigurationBaseForm):
    ...
    self.attchmentTableButtonsHorizontalLayout = QtWidgets.QHBoxLayout()
    self.attchmentTableButtonsHorizontalLayout.setContentsMargins(0, 5, 0, 5)
    self.attchmentTableButtonsHorizontalLayout.setObjectName("attchmentTableButtonsHorizontalLayout")
    ...
    self.attchmentTableButtonsHorizontalLayout.addWidget(self.addAttachmentPushButton)
    spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
    self.attchmentTableButtonsHorizontalLayout.addItem(spacerItem1)
    self.mainGridLayout.addLayout(self.attchmentTableButtonsHorizontalLayout, 13, 0, 1, 1)
  ...
  def retranslateUi(self, OntologyConfigurationBaseForm):
    ...
    self.typeLinkLineEdit.setToolTip(_translate("OntologyConfigurationBaseForm", "Enter the link/iri to be associated with this data-type"))
    self.typeLinkLineEdit.setPlaceholderText(_translate("OntologyConfigurationBaseForm", "Enter the iri for the type"))
