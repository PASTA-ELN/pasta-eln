...
class Ui_OntologyConfigurationBaseForm(object):
  ...
  def retranslateUi(self, OntologyConfigurationBaseForm):
    ...
    self.addMetadataRowPushButton.setToolTip(_translate("OntologyConfigurationBaseForm", "Add a new property row to the above table with empty values"))
    self.addMetadataRowPushButton.setText(_translate("OntologyConfigurationBaseForm", "+ Add Property"))
