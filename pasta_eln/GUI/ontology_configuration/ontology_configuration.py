...
class Ui_OntologyConfigurationBaseForm(object):
  def setupUi(self, OntologyConfigurationBaseForm):
    ...
    self.addPropsCategoryLineEdit.setClearButtonEnabled(True)
    ...
    self.typeLabelLineEdit.setClearButtonEnabled(True)
    ...
    self.propsTableButtonHorizontalLayout.addItem(spacerItem1)
    ...
    font = QtGui.QFont()
    font.setBold(True)
    self.propertiesTableHeaderLabel.setFont(font)
