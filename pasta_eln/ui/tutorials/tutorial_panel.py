...
class TutorialPanel(QWidget):
  ...
  def __init__(self, comm:Communicate, manager: TutorialManager) -> None:
    ...
    self.image = Image(imgData, self.introL, width=startWidth)
    ...
    self.textBrowser.setMinimumHeight(int(startWidth*0.8))
  ...
  def _updateInstructionHeight(self) -> None:
    ...
    document.setTextWidth(startWidth-20)
    document.adjustSize()
