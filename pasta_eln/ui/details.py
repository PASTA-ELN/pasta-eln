...
from ..fixed_strings_json import SORTED_DB_KEYS, cssStyleHtmlEditors, defaultDataHierarchyNode
from ..misc_tools import isDocID
from ..text_tools.handle_dictionaries import dict2ul
from ..text_tools.string_changes import markdownEqualizer, tuple2html
from ._context_menu import CommandMenu, executeContextMenu, initContextMenu
from .gui_communicate import Communicate
from .gui_style import IconButton, Image, Label, TextButton, widgetAndLayout
...
class Details(QScrollArea):
  ...
  def addDocDetails(self, layout:QLayout, key:str, value:Any, dataHierarchyNode:list[dict[str,Any]]) -> str:
    ...
    if key=='tags':
      ...
      labelStr = f'{labelStr[:maxLengthStr]}...' if len(labelStr)>maxLengthStr else labelStr
      if layout is not None:
