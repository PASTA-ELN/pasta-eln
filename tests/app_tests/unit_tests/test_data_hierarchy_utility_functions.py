...
class TestDataHierarchyUtilityFunctions(object):
  ...
  def test_get_formatted_missing_or_duplicate_metadata_message_returns_expected_message(self,
                                                                                        missing_metadata,
                                                                                        missing_names,
                                                                                        expected_message,
                                                                                        duplicate_metadata):
    assert (get_missing_metadata_message(missing_metadata, missing_names, duplicate_metadata)
            == expected_message), "get_missing_metadata_message should return expected"
