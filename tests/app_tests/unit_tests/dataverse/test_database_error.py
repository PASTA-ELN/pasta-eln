...
class TestDatabaseError:
  ...
  @pytest.mark.parametrize("test_id, message, detailed_errors, expected_message, expected_detailed_errors", [
    ...
    ("success", "Connection failed", {"code": "CONN_ERR"}, "Connection failed", {"code": "CONN_ERR"}),
    ("success", "Query execution aborted", {"query": "SELECT *"}, "Query execution aborted", {"query": "SELECT *"}),
