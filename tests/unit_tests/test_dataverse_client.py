...
class TestDataverseClient(object):
  ...
  async def test_check_if_token_expired_success_returns_true(self, mocker,
    ...
    mock_get_token_info = {'status': 200, 'reason': 'OK', 'result': {'status': 'OK',
      'data': {'message': f'Token {dataverse_client_mock.api_token} expires on 2024-12-04 14:18:49.967'}}}
  ...
  async def test_check_if_token_expired_not_expired_returns_false(self, mocker,
                                                                  dataverse_client_mock: dataverse_client_mock):
    mock_get_token_info = {'status': 200, 'reason': 'OK', 'result': {'status': 'OK',
      'data': {'message': f'Token {dataverse_client_mock.api_token} expires on 2024-01-04 14:18:49.967'}}}
    result_future = Future()
    result_future.set_result(mock_get_token_info)
  ...
  async def test_recreate_api_token_for_valid_token_should_succeed_return_new_token(self, mocker,
    ...
    mocked_new_token_result = {'status': 200, 'reason': 'OK',
      'result': {'status': 'OK', 'data': {'message': 'New token for dataverseAdmin is new_token'}}}
    result_future = Future()
  ...
  async def test_data_verse_creation_publish_when_succeeds_returns_expected(self, mocker,
    ...
    mock_create_dataverse_response = {'status': 201, 'reason': 'Created', 'result': {'status': 'OK',
      'data': {'id': 2107245, 'alias': test_alias_name, 'name': test_name,
        'affiliation': 'Scientific Research University',
        'dataverseContacts': [{'displayOrder': 0, 'contactEmail': 'pi@example.edu'}], 'permissionRoot': True,
        'description': 'Rest', 'dataverseType': 'RESEARCH_PROJECTS', 'ownerId': 1,
    ...
    metadata = {"name": "test_name", "alias": "test_alias_name",
      "dataverseContacts": [{"contactEmail": "pi@example.edu"}], "affiliation": "Scientific Research University",
  ...
  async def test_get_dataverse_contents_for_valid_id_must_returns_valid_content(self, mocker,
    ...
    dataverse_content = {'status': 200, 'reason': 'OK', 'result': {'status': 'OK',
      'data': [{'type': 'dataverse', 'id': 95, 'title': 'Dataverse Admin Dataverse'},
               {'id': 44, 'identifier': 'FK2/3BQJ5B', 'persistentUrl': 'https://doi.org/10.5072/FK2/3BQJ5B',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-11-29',
                'storageIdentifier': 'local://10.5072/FK2/3BQJ5B', 'type': 'dataset'},
               {'id': 45, 'identifier': 'FK2/6E9KJQ', 'persistentUrl': 'https://doi.org/10.5072/FK2/6E9KJQ',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-11-29',
                'storageIdentifier': 'local://10.5072/FK2/6E9KJQ', 'type': 'dataset'},
               {'id': 58, 'identifier': 'FK2/RN7AIV', 'persistentUrl': 'https://doi.org/10.5072/FK2/RN7AIV',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/RN7AIV', 'type': 'dataset'},
               {'id': 64, 'identifier': 'FK2/P9JWB4', 'persistentUrl': 'https://doi.org/10.5072/FK2/P9JWB4',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/P9JWB4', 'type': 'dataset'},
               {'id': 65, 'identifier': 'FK2/PI1EPG', 'persistentUrl': 'https://doi.org/10.5072/FK2/PI1EPG',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/PI1EPG', 'type': 'dataset'},
               {'id': 66, 'identifier': 'FK2/QJQ4YY', 'persistentUrl': 'https://doi.org/10.5072/FK2/QJQ4YY',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/QJQ4YY', 'type': 'dataset'},
               {'id': 67, 'identifier': 'FK2/VCADSB', 'persistentUrl': 'https://doi.org/10.5072/FK2/VCADSB',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/VCADSB', 'type': 'dataset'},
               {'id': 68, 'identifier': 'FK2/ZWOINS', 'persistentUrl': 'https://doi.org/10.5072/FK2/ZWOINS',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/ZWOINS', 'type': 'dataset'},
               {'id': 69, 'identifier': 'FK2/JRRO5W', 'persistentUrl': 'https://doi.org/10.5072/FK2/JRRO5W',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-12-05',
                'storageIdentifier': 'local://10.5072/FK2/JRRO5W', 'type': 'dataset'},
               {'id': 70, 'identifier': 'FK2/AMYNKF', 'persistentUrl': 'https://doi.org/10.5072/FK2/AMYNKF',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-12-01',
                'storageIdentifier': 'local://10.5072/FK2/AMYNKF', 'type': 'dataset'},
               {'id': 71, 'identifier': 'FK2/S5X6JS', 'persistentUrl': 'https://doi.org/10.5072/FK2/S5X6JS',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-12-01',
                'storageIdentifier': 'local://10.5072/FK2/S5X6JS', 'type': 'dataset'},
               {'id': 72, 'identifier': 'FK2/LJQT5M', 'persistentUrl': 'https://doi.org/10.5072/FK2/LJQT5M',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root',
                'storageIdentifier': 'local://10.5072/FK2/LJQT5M', 'type': 'dataset'},
               {'id': 73, 'identifier': 'FK2/SD5OT9', 'persistentUrl': 'https://doi.org/10.5072/FK2/SD5OT9',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-12-01',
                'storageIdentifier': 'local://10.5072/FK2/SD5OT9', 'type': 'dataset'},
               {'id': 74, 'identifier': 'FK2/3N5ALJ', 'persistentUrl': 'https://doi.org/10.5072/FK2/3N5ALJ',
                'protocol': 'doi', 'authority': '10.5072', 'publisher': 'Root', 'publicationDate': '2023-12-01',
  ...
  async def test_get_dataverse_size_for_valid_id_must_returns_valid_content(self, mocker,
    ...
    dataverse_size = {'status': 200, 'reason': 'OK', 'result': {'status': 'OK',
      'data': {'message': 'Total size of the files stored in this dataverse: 720,190,291 bytes'}}}
    dataverse_content_future = Future()
  ...
  async def test_create_dataset_succeed_should_return_expected_result(self, mocker,
    ...
    dataset_create_response = {"status": 201, "reason": "Created",
      "result": {"status": "OK", "data": {"id": 105, "persistentId": "doi:10.5072/FK2/KTE31V"}}}
    dataset_publish_response = {"status": 200, "reason": "OK", "result": {"status": "OK",
      "data": {"id": 105, "identifier": "FK2/KTE31V", "persistentUrl": "https://doi.org/10.5072/FK2/KTE31V",
        "protocol": "doi", "authority": "10.5072", "publisher": "Root",
    ...
    author = [
      {"authorName": {"typeName": "authorName", "multiple": False, "typeClass": "primitive", "value": "Steven, Jacob"},
        "authorAffiliation": {"typeName": "authorAffiliation", "multiple": False, "typeClass": "primitive",
          "value": "FZJ"}, "authorIdentifierScheme": {"typeName": "authorIdentifierScheme", "multiple": False,
    ...
    restructured_metadata = {
      "datasetVersion": {"license": {"name": "CC0 1.0", "uri": "http://creativecommons.org/publicdomain/zero/1.0"},
          ...
          "fields": [{"typeName": "title", "multiple": False, "typeClass": "primitive", "value": "Test Data Set"},
            ...
            {"typeName": "datasetContact", "multiple": True, "typeClass": "compound", "value": [{
              ...
              "datasetContactAffiliation": {"typeName": "datasetContactAffiliation", "multiple": False,
                "typeClass": "primitive", "value": "test Affiliation"},
              "datasetContactEmail": {"typeName": "datasetContactEmail", "multiple": False, "typeClass": "primitive",
                "value": "test@test.com"}}]}, {"typeName": "dsDescription", "multiple": True, "typeClass": "compound",
              "value": [{
                "dsDescriptionValue": {"typeName": "dsDescriptionValue", "multiple": False, "typeClass": "primitive",
                  "value": "Description 1"},
                "dsDescriptionDate": {"typeName": "dsDescriptionDate", "multiple": False, "typeClass": "primitive",
            ...
            {"typeName": "language", "multiple": True, "typeClass": "controlledVocabulary",
              "value": ["English", "German"]},
            {"typeName": "otherReferences", "multiple": True, "typeClass": "primitive",
              "value": ["Ref1", "Ref2", "Ref3"]}]}, "geospatial": {"fields": [
          {"typeName": "geographicCoverage", "multiple": True, "typeClass": "compound", "value": [{
            "country": {"typeName": "country", "multiple": False, "typeClass": "controlledVocabulary",
              "value": "Albania"},
            "state": {"typeName": "state", "multiple": False, "typeClass": "primitive", "value": "AlbaniaState"},
            "city": {"typeName": "city", "multiple": False, "typeClass": "primitive", "value": "AlbaniaCity"},
            "otherGeographicCoverage": {"typeName": "otherGeographicCoverage", "multiple": False,
              "typeClass": "primitive", "value": "CoverageOther"}}]}]}, "socialscience": {"fields": [
          {"typeName": "researchInstrument", "multiple": False, "typeClass": "primitive", "value": "Instruments1"}]},
          "astrophysics": {"fields": [
            {"typeName": "astroType", "multiple": True, "typeClass": "controlledVocabulary", "value": ["Mosaic"]},
            {"typeName": "astroFacility", "multiple": True, "typeClass": "primitive", "value": ["AIK-2", "AIK-3"]}]},
          "biomedical": {"fields": [
            {"typeName": "studyDesignType", "multiple": True, "typeClass": "controlledVocabulary",
              "value": ["Case Control", "Cross Sectional"]},
            {"typeName": "studyAssayOrganism", "multiple": True, "typeClass": "controlledVocabulary",
              "value": ["Arabidopsis thaliana", "Bos taurus", "Zea mays"]},
            {"typeName": "studyAssayCellType", "multiple": True, "typeClass": "primitive",
              "value": ["CellType1", "CellType2"]}]}, "journal": {"fields": [
            {"typeName": "journalVolumeIssue", "multiple": True, "typeClass": "compound", "value": [{
              "journalVolume": {"typeName": "journalVolume", "multiple": False, "typeClass": "primitive",
                "value": "2333.444"},
              "journalIssue": {"typeName": "journalIssue", "multiple": False, "typeClass": "primitive",
                "value": "Journal3.4"},
  ...
  async def test_dataset_upload_file_fails_with_error_should_return_expected_error(self, mocker,
    ...
    dataverse_client_mock.logger.info.assert_called_once_with("Uploading file: %s to Dataset: %s on server: %s",
      test_file_path, test_ds_pid, dataverse_client_mock.server_url)
    ...
    dataverse_client_mock.http_client.post.assert_has_calls([
      mocker.call(f"{dataverse_client_mock.server_url}/api/datasets/:persistentId/add",
        ...
        request_headers={'X-Dataverse-key': dataverse_client_mock.api_token}, data=mock_form_data.return_value,
        timeout=0)])
  ...
  async def test_dataset_upload_file_succeed_should_return_expected_result(self, mocker,
    ...
    upload_response = {"status": 200, "reason": "OK", "result": {"status": "OK",
      "message": {"message": "This file has the same content as ds_file.txt that is in the dataset. "}, "data": {
        "files": [{"description": "Test description ##", "label": "ds_file-1.txt", "restricted": False, "version": 1,
          "datasetVersionId": 86, "categories": ["Test tag1", "Test tag2"],
          "dataFile": {"id": 108, "persistentId": "", "filename": "ds_file-1.txt", "contentType": "multipart/form-data",
            "friendlyType": "multipart/form-data", "filesize": 15, "description": "Test description ##",
            "categories": ["Test tag1", "Test tag2"], "storageIdentifier": "local://18c587171cc-93f2e67da5b5",
            "rootDataFileId": -1, "md5": "13fd6190998e143667614471a36aa701",
            "checksum": {"type": "MD5", "value": "13fd6190998e143667614471a36aa701"}, "tabularData": False,
            "creationDate": "2023-12-11", "fileAccessRequest": True}}]}}}
    publish_response = {"status": 200, "reason": "OK", "result": {"status": "OK",
      "data": {"id": 105, "identifier": "FK2/KTE31V", "persistentUrl": "https://doi.org/10.5072/FK2/KTE31V",
        "protocol": "doi", "authority": "10.5072", "publisher": "Root", "publicationDate": "2023-12-11",
        "storageIdentifier": "local://10.5072/FK2/KTE31V"}}}
    upload_future = Future()
    upload_future.set_result(upload_response)
    publish_future = Future()
    ...
    assert result == {'file_upload_result': upload_response.get('result').get('data'),
      'dataset_publish_result': publish_response.get('result').get('data')}, "Upload result not as expected!"
    dataverse_client_mock.logger.info.assert_called_once_with("Uploading file: %s to Dataset: %s on server: %s",
      test_file_path, test_ds_pid, dataverse_client_mock.server_url)
    mock_basename.assert_called_once_with(test_file_path)
    mock_dumps.assert_called_once_with(dict(description=test_desc, categories=test_categories))
    ...
    dataverse_client_mock.http_client.post.assert_has_calls([
      mocker.call(f"{dataverse_client_mock.server_url}/api/datasets/:persistentId/add",
        request_params={'persistentId': test_ds_pid},
        request_headers={'X-Dataverse-key': dataverse_client_mock.api_token}, data=mock_form_data.return_value,
        timeout=0), mocker.call(f"{dataverse_client_mock.server_url}/api/datasets/:persistentId/actions/:publish",
  ...
  async def test_get_dataset_info_json_when_succeeds_return_dataset_json(self, mocker,
    ...
    dataset_info_response = {"status": 200, "reason": "OK", "result": {"status": "OK",
      "data": {"id": 91, "datasetId": 105, "datasetPersistentId": "doi:10.5072/FK2/KTE31V",
        "storageIdentifier": "local://10.5072/FK2/KTE31V", "versionNumber": 8, "versionMinorNumber": 0,
        "versionState": "RELEASED", "lastUpdateTime": "2023-12-11T11:16:14Z", "releaseTime": "2023-12-11T11:16:14Z",
        "createTime": "2023-12-11T11:15:25Z", "publicationDate": "2023-12-11", "citationDate": "2023-12-11",
        "license": {"name": "CC0 1.0", "uri": "http://creativecommons.org/publicdomain/zero/1.0",
          "iconUri": "https://licensebuttons.net/p/zero/1.0/88x31.png"}, "fileAccessRequest": True, "metadataBlocks": {
          "citation": {"displayName": "Citation Metadata", "name": "citation",
            "fields": [{"typeName": "title", "multiple": False, "typeClass": "primitive", "value": "Test Data Set"},
              {"typeName": "author", "multiple": True, "typeClass": "compound", "value": [{
                "authorName": {"typeName": "authorName", "multiple": False, "typeClass": "primitive",
                  "value": "Steven, Jacob"},
          ...
          "geospatial": {"displayName": "Geospatial Metadata", "name": "geospatial", "fields": [
            {"typeName": "geographicCoverage", "multiple": True, "typeClass": "compound", "value": [{
              "country": {"typeName": "country", "multiple": False, "typeClass": "controlledVocabulary",
                "value": "Albania"},
              "state": {"typeName": "state", "multiple": False, "typeClass": "primitive", "value": "AlbaniaState"},
              ...
              "otherGeographicCoverage": {"typeName": "otherGeographicCoverage", "multiple": False,
                "typeClass": "primitive", "value": "CoverageOther"}}]}]},
          "socialscience": {"displayName": "Social Science and Humanities Metadata", "name": "socialscience",
            "fields": [{"typeName": "researchInstrument", "multiple": False, "typeClass": "primitive",
              "value": "Instruments1"}]},
          "astrophysics": {"displayName": "Astronomy and Astrophysics Metadata", "name": "astrophysics", "fields": [
            {"typeName": "astroType", "multiple": True, "typeClass": "controlledVocabulary", "value": ["Mosaic"]},
            {"typeName": "astroFacility", "multiple": True, "typeClass": "primitive", "value": ["AIK-2", "AIK-3"]}]},
          "biomedical": {"displayName": "Life Sciences Metadata", "name": "biomedical", "fields": [
            {"typeName": "studyDesignType", "multiple": True, "typeClass": "controlledVocabulary",
              "value": ["Case Control", "Cross Sectional"]},
            {"typeName": "studyAssayOrganism", "multiple": True, "typeClass": "controlledVocabulary",
              "value": ["Arabidopsis thaliana", "Bos taurus", "Zea mays"]},
            {"typeName": "studyAssayCellType", "multiple": True, "typeClass": "primitive",
              "value": ["CellType1", "CellType2"]}]}, "journal": {"displayName": "Journal Metadata", "name": "journal",
            "fields": [{"typeName": "journalVolumeIssue", "multiple": True, "typeClass": "compound", "value": [{
              "journalVolume": {"typeName": "journalVolume", "multiple": False, "typeClass": "primitive",
                "value": "2333.444"},
              "journalIssue": {"typeName": "journalIssue", "multiple": False, "typeClass": "primitive",
                "value": "Journal3.4"},
              "journalPubDate": {"typeName": "journalPubDate", "multiple": False, "typeClass": "primitive",
                "value": "2021-10-10"}}]}]}}, "files": [
          {"description": "Test description ##", "label": "ds_file-2.txt", "restricted": False, "version": 1,
            "datasetVersionId": 91, "categories": ["Test tag1", "Test tag2"],
            "dataFile": {"id": 109, "persistentId": "", "filename": "ds_file-2.txt",
              "contentType": "multipart/form-data", "friendlyType": "multipart/form-data", "filesize": 15,
              "description": "Test description ##", "categories": ["Test tag1", "Test tag2"],
              "storageIdentifier": "local://18c588e6aed-6470c8026250", "rootDataFileId": -1,
              "md5": "13fd6190998e143667614471a36aa701",
              "checksum": {"type": "MD5", "value": "13fd6190998e143667614471a36aa701"}, "tabularData": False,
              "creationDate": "2023-12-11", "publicationDate": "2023-12-11", "fileAccessRequest": True}},
          {"description": "Test description ##", "label": "trials_after_couch_db_re_install.webm", "restricted": False,
            "version": 1, "datasetVersionId": 91, "categories": ["Test tag1", "Test tag2"],
            "dataFile": {"id": 111, "persistentId": "", "filename": "trials_after_couch_db_re_install.webm",
              "contentType": "multipart/form-data", "friendlyType": "multipart/form-data", "filesize": 132505595,
              "description": "Test description ##", "categories": ["Test tag1", "Test tag2"],
              "storageIdentifier": "local://18c5890e6ac-258ade1533f6", "rootDataFileId": -1,
              "md5": "67c1921cc78d5314d031351f763d4cfa",
              "checksum": {"type": "MD5", "value": "67c1921cc78d5314d031351f763d4cfa"}, "tabularData": False,
              "creationDate": "2023-12-11", "publicationDate": "2023-12-11", "fileAccessRequest": True}}]}}}
    info_future = Future()
  ...
  async def test_get_dataset_versions_when_fails_returns_error(self, mocker,
    ...
    version_info = {"status": 404, "reason": "Not Found",
      "result": {"status": "ERROR", "message": "Dataset with Persistent ID doi:10.5072/FK2/JRRO5W4 not found."}}
    info_future = Future()
    info_future.set_result(version_info)
    mocker.patch.object(dataverse_client_mock.http_client, 'get', side_effect=[info_future])
    result = await dataverse_client_mock.get_dataset_versions("test_id")
  ...
  async def test_get_dataset_metadata_block_when_succeeds_returns_expected(self, mocker,
    ...
    metadata_info = {"status": 200, "reason": "OK", "result": {"status": "OK",
      "data": {"biomedical:studyAssayCellType": ["CellType1", "CellType2"], "language": ["English", "German"],
        "socialscience:researchInstrument": "Instruments1",
        "biomedical:studyDesignType": ["Case Control", "Cross Sectional"],
        "biomedical:studyAssayOrganism": ["Arabidopsis thaliana", "Bos taurus", "Zea mays"],
        "otherReferences": ["Ref1", "Ref2", "Ref3"], "astrophysics:astroFacility": ["AIK-2", "AIK-3"],
        "astrophysics:astroType": "Mosaic", "subject": ["Chemistry", "Engineering"], "title": "Test Data Set",
        "geospatial:geographicCoverage": {"geospatial:country": "Albania", "geospatial:state": "AlbaniaState",
          "geospatial:city": "AlbaniaCity", "geospatial:otherGeographicCoverage": "CoverageOther"},
        "journal:journalVolumeIssue": {"journal:journalVolume": "2333.444", "journal:journalIssue": "Journal3.4",
          "journal:journalPubDate": "2021-10-10"},
        "citation:datasetContact": {"citation:datasetContactName": "Rashid, Muhammed",
          "citation:datasetContactAffiliation": "test Affiliation", "citation:datasetContactEmail": "test@test.com"},
        "author": [{"citation:authorName": "Steven, Jacob", "citation:authorAffiliation": "FZJ",
          "authorIdentifierScheme": "ORCID", "authorIdentifier": "1234-5678-9012-3456"},
          {"citation:authorName": "Leslie, Suzanne", "citation:authorAffiliation": "FZJ",
            "authorIdentifierScheme": "ISNI", "authorIdentifier": "4567-8901-2345-6789"}], "citation:dsDescription": [
          {"citation:dsDescriptionValue": "Description 1", "citation:dsDescriptionDate": "2020-11-10"},
          {"citation:dsDescriptionValue": "Description 2", "citation:dsDescriptionDate": "201-12-25"}],
        "@id": "https://doi.org/10.5072/FK2/JRRO5W", "@type": ["ore:Aggregation", "schema:Dataset"],
        "schema:version": "2.0", "schema:name": "Test Data Set", "schema:dateModified": "Mon Dec 11 14:53:50 UTC 2023",
        "schema:datePublished": "2023-12-05", "schema:creativeWorkStatus": "RELEASED",
        "schema:license": "http://creativecommons.org/publicdomain/zero/1.0",
        "dvcore:fileTermsOfAccess": {"dvcore:fileRequestAccess": True}, "schema:includedInDataCatalog": "Root",
        "schema:isPartOf": {"schema:name": "newDataVerse3", "@id": "http://localhost:8080/dataverse/newDataVerse3",
          "schema:description": "newDS",
          "schema:isPartOf": {"schema:name": "Root", "@id": "http://localhost:8080/dataverse/root",
            "schema:description": "The root dataverse."}},
        "@context": {"astrophysics": "http://localhost:8080/schema/astrophysics#",
          ...
          "citation": "https://dataverse.org/schema/citation/", "dcterms": "http://purl.org/dc/terms/",
          "dvcore": "https://dataverse.org/schema/core#", "geospatial": "http://localhost:8080/schema/geospatial#",
          "journal": "http://localhost:8080/schema/journal#", "language": "http://purl.org/dc/terms/language",
          "ore": "http://www.openarchives.org/ore/terms/", "otherReferences": "http://purl.org/dc/terms/references",
          "schema": "http://schema.org/", "socialscience": "http://localhost:8080/schema/socialscience#",
          "subject": "http://purl.org/dc/terms/subject", "title": "http://purl.org/dc/terms/title"}}}}
    info_future = Future()
  ...
  async def test_get_dataset_metadata_block_when_fails_returns_error(self, mocker,
    ...
    metadata_error_info = {"status": 404, "reason": "Not Found",
      "result": {"status": "ERROR", "message": "Dataset with Persistent ID doi:10.5072/FK2/JRRO5W3 not found."}}
  ...
  async def test_delete_non_empty_dataverse_when_fails_returns_error(self, mocker,
    ...
    delete_info_error = {"status": 404, "reason": "Not Found",
      "result": {"status": "ERROR", "message": "Can't find dataverse with identifier='dataverse12344'"}}
    delete_future = Future()
