...
class TestDataverseConfigModel:
  ...
  @pytest.mark.parametrize(
    ...
    [("success_case_full", "id123", "rev123", {"item1": "data1"}, 5, {"user": "test_user"}, {"title": "Test Metadata"}),
      ("success_case_minimal", None, None, None, None, None, None), # Add more test cases as needed
  ...
  @pytest.mark.parametrize(
    "test_id, _id, _rev, project_upload_items, parallel_uploads_count, dataverse_login_info, metadata",
    [("edge_case_empty_strings", "", "", {}, 0, {}, {}), # Add more edge cases as needed
    ], ids=lambda test_id: test_id)
  ...
  @pytest.mark.parametrize(
    ...
    IncorrectParameterError), # Add more error cases as needed
    ], ids=lambda test_id: test_id)
  def test_init_error_cases(self, test_id, _id, _rev, project_upload_items, parallel_uploads_count,
                            dataverse_login_info, metadata, expected_exception):
    # Act & Assert
